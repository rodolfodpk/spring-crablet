...
/**
 * Seeds {@code crablet_view_progress} rows for view management integration tests.
 */
public final class ViewProgressFixtures {
    ...
    public static void insertWithErrorColumns(
        ...
        jdbc.update(
                """
                INSERT INTO crablet_view_progress (view_name, instance_id, status, last_position, error_count,
