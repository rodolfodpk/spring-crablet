/**
 * Root package for the Crablet framework.
 * <p>
 * Crablet is a lightweight event sourcing framework with Spring Boot integration,
 * providing DCB (Dynamic Consistency Boundary) support for optimistic concurrency control.
 * <p>
 * This package serves as the root namespace for the framework. For framework usage,
