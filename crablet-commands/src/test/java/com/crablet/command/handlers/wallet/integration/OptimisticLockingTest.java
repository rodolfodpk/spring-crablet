...
class OptimisticLockingTest extends AbstractPostgresEventStoreTest {
    ...
    void shouldValidateAppendConditionStreamPositionCorrectly() {
        ...
        List<com.crablet.eventstore.StoredEvent> depositEvents = testHelper.query(depositQuery, null);
    ...
    void shouldHandleAppendConditionWithMultipleTags() {
        ...
        com.crablet.eventstore.StoredEvent event = depositEvents.get(0);
