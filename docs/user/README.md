...
| Path | Contents |
|------|----------|
| [QUICKSTART.md](QUICKSTART.md) | Fastest path with the wallet example |
...
| [DEPLOYMENT_TOPOLOGY.md](DEPLOYMENT_TOPOLOGY.md), [LEADER_ELECTION.md](LEADER_ELECTION.md), … | Operations and deployment |
| [ai-tooling/](ai-tooling/) | Event-model–driven codegen workflows and AI skill routing |
