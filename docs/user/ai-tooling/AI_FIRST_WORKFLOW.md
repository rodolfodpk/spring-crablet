...
[Course Core Workflow](COURSE_CORE_WORKFLOW.md). For the broader Course example with automation
and outbox concepts, see [Course Enrollment Showcase](COURSE_ENROLLMENT_SHOWCASE.md). For a
concrete generated-slice input, see
