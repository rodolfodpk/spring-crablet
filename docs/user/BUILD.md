...
It carries all database migrations (V1–V9) so every module gets them automatically
...
- `classpath:db/migration` — framework tables V1–V9 from `crablet-db-migrations`
