...
![Wallet Event Model](docs/wallet-event-model.drawio.png)

### Course Event Model

![Course Event Model](docs/course-event-model.drawio.png)

> Source files: [wallet-event-model.drawio](docs/wallet-event-model.drawio), [course-event-model.drawio](docs/course-event-model.drawio).
