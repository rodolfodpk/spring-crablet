 ...
 */
public class ProcessorManagementServiceImpl<T extends com.crablet.eventpoller.processor.ProcessorConfig<I>, I> 
    ...
    public BackoffInfo getBackoffInfo(I processorId) {
        ...
        if (eventProcessor instanceof com.crablet.eventpoller.processor.EventProcessorImpl) {
            @SuppressWarnings("unchecked")
            com.crablet.eventpoller.processor.EventProcessorImpl<T, I> impl = 
                (com.crablet.eventpoller.processor.EventProcessorImpl<T, I>) eventProcessor;
            
            com.crablet.eventpoller.backoff.BackoffState backoffState = impl.getBackoffState(processorId);
    ...
    public Map<I, BackoffInfo> getAllBackoffInfo() {
        ...
        if (eventProcessor instanceof com.crablet.eventpoller.processor.EventProcessorImpl) {
            ...
            Map<I, com.crablet.eventpoller.backoff.BackoffState> backoffStates = impl.getAllBackoffStates();
            for (var entry : backoffStates.entrySet()) {
                com.crablet.eventpoller.backoff.BackoffState state = entry.getValue();
