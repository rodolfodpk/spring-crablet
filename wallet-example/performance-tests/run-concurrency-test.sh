...
echo "🚀 Starting Concurrency Conflict Test..."
...
seed_data() {
  echo "🌱 Seeding concurrency conflict test data..."
  "${K6_BIN}" run "${PERF_TESTS_DIR}/setup/seed-concurrency-data.js"
  echo "✅ Concurrency conflict test data seeding complete."
}
...
# Run concurrency conflict test
run_k6_test "transfer-concurrency-conflict.js" "Transfer Concurrency Conflict Test"

echo "🎉 Concurrency conflict test completed successfully!"
