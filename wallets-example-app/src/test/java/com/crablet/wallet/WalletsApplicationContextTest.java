...
import com.crablet.wallet.query.WalletQueryController;
 ...
 * </ul>
 */
@DisplayName("Wallets Application Context Tests")
class WalletsApplicationContextTest extends AbstractWalletsTest {
